<template>
  <div>
    ...
    >
      <template #action>
        <div class="pl5 pr5 f-h5-theme" @click="onSearch">tìm kiếm</div>
      </template>
    </van-search> -->
    ...
    <div class="sercarh">
      ...
      <div class="sercarh-btn">tìm kiếm</div>
    </div>
    ...
    <div class="pl15 pr15 mt10 f14">
      ...
      <ul class="flex flex-wrap">
        <li class="hot flex-center" v-for="(item, index) in project.config.hotList" :key="index" @click="onHot(item)">
